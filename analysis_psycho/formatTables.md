Formatting tables for the psychology paper
================
Marius Bottin
2024-06-03

- [1 Importing data](#1-importing-data)
- [2 Filter: concerns students](#2-filter-concerns-students)
- [3 Concerns psychologists](#3-concerns-psychologists)
- [4 Countries](#4-countries)
- [5 Final tables](#5-final-tables)
...
```
    ...
    ## 
    ##   Entourage (parents)  Entourage (Teachers)              students 
    ##                     3                    26                     3 
    ##              Students  Students and parents Students and teachers 
    ##                   114                     4                     2
...
```
    ...
    ##        
    ## toKeep  Entourage (parents) Entourage (Teachers) students Students
    ##   FALSE                   3                   26        0        0
    ##   TRUE                    0                    0        3      114
    ##        
    ## toKeep  Students and parents Students and teachers
    ##   FALSE                    0                     0
    ##   TRUE                     4                     2
...
```
    ...
    ##                            1                            1 
    ##        Community development Data management and analysis 
    ##                            1                            1 
    ##  Data Managment and analysis                    Economics 
    ##                            1                            1 
    ##                    Education                   Education  
    ##                           14                            1 
    ##                  Engineering   Fire fighters coordination 
    ##                           10                            1 
    ##                       Health              Health Sciences 
    ##                            1                            1 
    ##                    Hydrology                          Law 
    ##                            1                            1 
    ##            Learning sciences                   Management 
    ##                            1                            1 
    ##                  Mathematics                     Medicine 
    ##                            1                            1 
    ##             Natural sciences             Natural Sciences 
    ##                           29                            5 
    ##            Natural sciencies                   Philosophy 
    ##                            1                            1 
    ##                   Psychiatry                   Psychology 
    ##                            1                            8 
    ##                Public sector              Social sciences 
    ##                            2                           11 
    ##              Student advisor    Youth development program 
    ##                            1                            1
...
![](formatTables_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
``` r
mitada<-datab$`mitigation.(reducir.causas)./.adaptación.(reducir.consecuencias)`[datab$Psychology.yes.or.no!=3]
...
saveWorkbook(wb,file="../../export_sr_cce/tables_for_psychology_paper.xlsx")
```
